...
<html>
    ...
    <body>
            ...
            <%
            //设置当前地址
            session.setAttribute("adress","book");
            session.setAttribute("bigclassify","图书");
            /* 获取cookie */
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="book"  type="hidden"/>
    ...
    <div class="container" style="margin-top: 60px;width: 1245px;">
        ...
        <div class="container allblurb">
            ...
            <div class="allblurb_1 wow fadeIn allblurb_query">
                    ...
                    <span><a href="#">金融与投资</a></span>
                    <span><a href="#">历史</a></span>
                    <span><a href="#">心理学</a></span>
                    <span><a href="#">政治军事</a></span>
                    <span><a href="#">哲学</a></span>
                    <span><a href="#">法律</a></span>
                    <span><a href="#">教学书</a></span>
                    <span><a href="#">时尚</a></span>
                    <span><a href="#">美食</a></span>
                    <span><a href="#">资格认证书籍</a></span>
            ...
            <div class="allblurb_2">
                <ul class="allblurb_21">
                    <li>
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/book1.png" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/book2.png" alt="商品图片" />
                        </a>
                    </li>
                    <li style="none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/book3.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
            ...
            <div class="allblurb_3">
                <img src="${pageContext.request.contextPath}/img/book3.jpg"/>
            </div>
        </div>
        <!--
            作者：1120551142@qq.com
