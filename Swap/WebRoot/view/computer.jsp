...
<html>
	...
	<body>
			...
			<%
			//设置当前地址
		session.setAttribute("adress","computer");
		session.setAttribute("bigclassify","电脑");
			/* 获取cookie */
						...
						<div class="tab-pane fade" id="xw1">
							...
							<div class="container">
								<form class="form-horizontal"
									...
									method="post">
									<input name="adress" value="computer"  type="hidden"/>
	...
	<div class="container" style="margin-top: 60px;width: 1245px;">
		...
		<div class="container allblurb">
			...
			<div class="allblurb_1 wow fadeIn allblurb_query">
						<span><a href="#">戴尔</a></span>
						<span><a href="#">联想</a></span>
						<span><a href="#">神舟</a></span>
						<span><a href="#">华硕</a></span>
						<span><a href="#">宏碁</a></span>
						<span><a href="#">天虹</a></span>
						<span><a href="#">雷霆世纪</a></span>
						<span><a href="#">惠普</a></span>
						<span><a href="#">苹果</a></span>
						<span><a href="#">微软</a></span>
						<span><a href="#">三星</a></span>
						<span><a href="#">索尼</a></span>
			...
			<div class="allblurb_2">
				<ul class="allblurb_21">
					<li>
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/comp1.png" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/comp2.png" alt="商品图片" />
						</a>
					</li>
					<li style="none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/comp3.png" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
			...
			<script>$('.allblurb_2').ckSlide({
				autoPlay: true, //默认为不自动播放，需要时请以此设置
				dir: 'x', //默认效果淡隐淡出，x为水平移动，y 为垂直滚动
				interval: 3000 //默认间隔2000毫秒
			});</script>
			<div class="allblurb_3">
				<img src="${pageContext.request.contextPath}/img/comp3.png"/>
			</div>
		</div>
		<!--
        	作者：1120551142@qq.com
