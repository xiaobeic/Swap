...
<html>
    ...
    <body>
            ...
            <%
            //设置当前地址
            session.setAttribute("adress","cases");
            session.setAttribute("bigclassify","箱包");
            /* 获取cookie */
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="cases"  type="hidden"/>
    ...
    <div class="container" style="margin-top: 60px;width: 1245px;">
        ...
        <div class="container allblurb">
            ...
            <div class="allblurb_1 wow fadeIn allblurb_query">
                <span><a href="#">女包</a></span>
                <span><a href="#">男包</a></span>
                <span><a href="#">真皮包</a></span>
                <span><a href="#">钱包</a></span>
                <span><a href="#">迷你包</a></span>
                <span><a href="#">双肩包</a></span>
                <span><a href="#">手提包</a></span>
                <span><a href="#">电脑包</a></span>
                <span><a href="#">登山包</a></span>
                <span><a href="#">书包</a></span>
                <span><a href="#">斜挎包</a></span>
                <span><a href="#">休闲包</a></span>
                <span><a href="#">拉杆箱</a></span>
                <span><a href="#">旅行箱</a></span>
            ...
            <div class="allblurb_2">
                <ul class="allblurb_21">
                    <li>
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/compage2.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/compage3.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/compage4.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
            ...
            <div class="allblurb_3">
                <img src="${pageContext.request.contextPath}/img/compage3.jpg"/>
            </div>
        </div>
        <!--
            作者：1120551142@qq.com
