...
<html>
 <head>
	...
	<body>
			<%
			//设置当前地址
		session.setAttribute("adress","subpage");
		session.setAttribute("bigclassify","汽车");
			/* 获取cookie */
						...
						<div class="tab-pane fade" id="xw1">
							...
							<div class="container">
								<form class="form-horizontal"
									...
									method="post">
									<input name="adress" value="subpage"  type="hidden"/>
									...
									<div class="form-group">
					<input type="checkbox" />					<div class="form-group-lg" style="width:300px;">
	...
	<div class="container" style="margin-top: 60px;width: 1245px;">
		...
		<div class="container allblurb">
			...
			<div class="allblurb_1 wow fadeIn allblurb_query">
				...
				<span><a href="#">大众</a></span>
				<span><a href="#">现代</a></span>
				<span><a href="#">本田</a></span>
				<span><a href="#">昌河</a></span>
				<span><a href="#">宝沃</a></span>
				<span><a href="#">铃木</a></span>
				<span><a href="#">别克</a></span>
				<span><a href="#">奇瑞</a></span>
				<span><a href="#">奔腾</a></span>
				<span><a href="#">宇通</a></span>
				<span><a href="#">一汽</a></span>
				<span><a href="#">宝骏</a></span>
				<span><a href="#">北京</a></span>
				<span><a href="#">双龙</a></span>
				<span><a href="#">雪铁龙</a></span>
				<span><a href="#">雪佛兰</a></span>
				<span><a href="#">保时捷</a></span>
				<span><a href="#">西雅特</a></span>
				<span><a href="#">特斯拉</a></span>
				<span><a href="#">帆加尼</a></span>
				<span><a href="#">斯柯达</a></span>
				<span><a href="#">MINI </a></span>
				<span><a href="#">KIM</a></span>
				<span><a href="#">凯迪拉克</a></span>
				<span><a href="#">长安轿车 </a></span>
				<span><a href="#">星客特</a></span>
			...
			<div class="allblurb_2">
				<ul class="allblurb_21">
					<li>
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/car1.jpg" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/car2.jpg" alt="商品图片" />
						</a>
					</li>
					<li style="none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/car3.jpg" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/car4.jpg" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/car5.jpg" alt="商品图片" />
						</a>
					</li>
				</ul>
			...
			<div class="allblurb_3">
				<img src="${pageContext.request.contextPath}/img/car6.jpg"/>
			</div>
		</div>
		<!--
        	作者：1120551142@qq.com
