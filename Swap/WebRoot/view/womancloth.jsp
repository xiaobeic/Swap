...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/shopPage.js"></script>
<script>
	new WOW().init();
	getTop();
	$(function() {
...
<body>
	<%
		//设置当前地址
		session.setAttribute("adress","womancloth");
		session.setAttribute("bigclassify","女装");
		/* 获取cookie */
				...
				<ul class="clearfix logined">
					...
					<li class="set_btn user-card-box"><a
						...
						href="${pageContext.request.contextPath}/shops/queryPsersonCenter1.do">
							<img src='/path/${user.headimg }' width='35'
							height='35' /> <i class="myspace_remind"
							...
							<div class="card-inner">
								<div class="card-top">
									<img src="/path/${user.headimg }"
										alt="${user.username }" class="l"> <span
										class="name text-ellipsis">${user.username }</span>
								</div>
						...
						<div class="tab-pane fade" id="xw1">
							...
							<div class="container">
								<form class="form-horizontal"
									...
									method="post">
									<input name="adress" value="womancloth"
										type="hidden" />
	...
	<div class="many_news container">
		<ul class="manyblurb">
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=男装&address=mancloth">男装</a>
			</li>
			<li class="active"><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=女装&address=womancloth">女装</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=箱包&address=cases">箱包</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=美妆&address=beauty">美妆</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=汽车&address=subpage">汽车</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=家居&address=house">家居</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=图书&address=book">图书</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=手机&address=cellphone">手机</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=电脑&address=computer">电脑</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=户外&address=outdoors">户外</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=食品&address=eatdrink">食品</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=其他&address=rest">其他</a>
			</li>
	...
	<div class="container allblurb">
		...
		<div class="allblurb_2">
			<ul class="allblurb_21">
				<li><a href="javascript:"> <img
						src="${pageContext.request.contextPath}/img/womancloth1.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/womancloth2.jpg"
						alt="商品图片" />
				</a></li>
				<li style="none"><a href="javascript:"> <img
						src="${pageContext.request.contextPath}/img/womancloth3.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/womancloth4.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/womancloth5.jpg"
						alt="商品图片" />
				</a></li>
			</ul>
		...
		<div class="allblurb_3">
			<img
				src="${pageContext.request.contextPath}/img/womancloth6.jpg" />
		</div>
	</div>
	<!--
        	作者：1120551142@qq.com
				...
				<c:forEach items="${goodsCustom }" var="goodsCustom">
					<div class="allblurb1_1 thumbnail">
						...
						<div class="goods_info_div1">
							...
							<p>
								<span>成&nbsp;&nbsp;色:</span> <span
									style="color: #FE6500;">${goodsCustom.quality }</span>
							</p>
							<p>
						...
						<div class="treasure_info_div2">
							<span class="glyphicon glyphicon-time" title="发布时间">
								<i style="color: #5E5E5E;"> <fmt:formatDate
										value="${goodsCustom.uploadtime }"
										pattern="yyyy-MM-dd" />
							</i>
							</span> <span class="glyphicon glyphicon-eye-open"
								title="浏览量"> <i style="color: #5E5E5E;">${goodsCustom.viewnumber }</i>
						</div>
	...
	<footer
		style="padding: 15px;margin-top: 60px;background-color: white;">
	...
	<div id="getTop" class="fixed-btn"
		style="background: #d0d6d9;-webkit-border-radius: 50%;display: none;">
		<a id="toTop"><span
