		...
		<div
			...
			<ul id="mytab" class="nav nav-tabs">
				<li id="mytab_li1"
					...
					id="login_a1" href='#xw1' data-toggle='tab' style="height: 50px;">登录</a>
				</li>
				<li id="mytab_li2"
					style="width: 174px;text-align: center;font-size: 18px;"><a
					id="login_a2" href='${pageContext.request.contextPath}/view/register.jsp' 
					style="margin: 0;height: 50px;">注册</a></li>
			</ul>
			<div class="tab-content">
				<div class="tab-pane fade" id="xw1" style="min-height: 280px;">
					<!-- 显示错误信息 -->
