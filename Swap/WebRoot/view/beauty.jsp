...
<body>
    ...
    <%
        //设置当前地址
        session.setAttribute("adress","beauty");
        //设置当前页面对应的大标签
        session.setAttribute("bigclassify","美妆");
        /* 获取cookie */
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active">
                    <a href="${pageContext.request.contextPath}/allgoods/selectallgoodss.action?bigclassify=男装&address=mancloth">商店</a></li>
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="beauty" type="hidden" />
    ...
    <div class="container allblurb">
        ...
        <div class="allblurb_1 wow fadeIn allblurb_query">","","","","","
            <span><a href="#">面部护肤</a></span> <span><a href="#">洗发护发</a></span> <span><a
                href="#">香水彩妆</a></span> <span><a href="#">沐浴用品</a></span> <span><a
                href="#">男士剃须</a></span> <span><a href="#">口腔护理</a></span> <span><a
                href="#">其他</a></span>
        </div>
        <!--轮播图-->
        ...
        <div class="allblurb_2">
            <ul class="allblurb_21">
                <li><a href="javascript:"> <img
                        src="${pageContext.request.contextPath}/img/meizhuang1.jpg"
                        alt="商品图片" />
                </a></li>
                <li style="display: none"><a href="javascript:"> <img
                        src="${pageContext.request.contextPath}/img/meizhuang2.jpg"
                        alt="商品图片" />
                </a></li>
                <li style="none"><a href="javascript:"> <img
                        src="${pageContext.request.contextPath}/img/meizhuang3.jpg"
                        alt="商品图片" />
                </a></li>
                <li style="display: none"><a href="javascript:"> <img
                        src="${pageContext.request.contextPath}/img/meizhuang2.jpg"
            ...
            <a href="javascript:;" class="ctrl-blurb allblurb_211">上一张</a> <a
                href="javascript:;" class="ctrl-blurb allblurb_212">下一张</a>
        ...
        <div class="allblurb_3">
            <img src="${pageContext.request.contextPath}/img/meizhuang2.jpg" />
        </div>
    </div>
    <!--
            作者：1120551142@qq.com
