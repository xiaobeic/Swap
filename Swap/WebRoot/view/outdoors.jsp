...
<html>
    ...
    <body>
            <%
            //设置当前地址
        session.setAttribute("adress","outdoors");
        session.setAttribute("bigclassify","户外");
            /* 获取cookie */
        ...
        <div class="modal-dialog" style="width:330px;">
            <div class="modal-content">
                <div class="modal-body">
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="outdoors"  type="hidden"/>
                    ...
                    <input type="checkbox" />                            <input type="checkbox" name="isUseCookie" checked="checked"/>  <span
    ...
    <div class="container" style="margin-top: 60px;width: 1245px;">
        ...
        <div class="container allblurb">
            ...
            <div class="allblurb_1 wow fadeIn allblurb_query">
                        <span><a href="#">户外服饰</a></span>
                        <span><a href="#">户外鞋服</a></span>
                        <span><a href="#">户外装备</a></span>
                        <span><a href="#">野炊烧烤</a></span>
                        <span><a href="#">游泳用品</a></span>
                        <span><a href="#">垂钓用品</a></span>
                        <span><a href="#">生活运动</a></span>
                        <span><a href="#">安全应急</a></span>
            ...
            <div class="allblurb_2">
                <ul class="allblurb_21">
                    <li>
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/huwai1.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/huwai2.png" alt="商品图片" />
                        </a>
                    </li>
                    <li style="none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/huwai3.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
            ...
            <div class="allblurb_3">
                <img src="${pageContext.request.contextPath}/img/huwai2.png"/>
            </div>
        </div>
        <!--
            作者：1120551142@qq.com
