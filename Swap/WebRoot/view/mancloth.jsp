...
<body>
	<%
		//设置当前地址
			session.setAttribute("adress","mancloth");
			session.setAttribute("bigclassify","男装");
		/* 获取cookie */
						...
						<div class="tab-pane fade" id="xw1">
							...
							<div class="container">
								<form class="form-horizontal"
									...
									method="post">
									<input name="adress" value="mancloth" type="hidden" />
	...
	<div class="container allblurb">
		...
		<div class="allblurb_2">
			<ul class="allblurb_21">
				<li><a href="javascript:"> <img
						src="${pageContext.request.contextPath}/img/mancloth3.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/mancloth2.jpg"
						alt="商品图片" />
				</a></li>
				<li style="none"><a href="javascript:"> <img
						src="${pageContext.request.contextPath}/img/mancloth1.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/mancloth4.jpg"
						alt="商品图片" />
				</a></li>
				<li style="display: none"><a href="javascript:">
						<img
						src="${pageContext.request.contextPath}/img/mancloth5.jpg"
						alt="商品图片" />
				</a></li>
			</ul>
		...
		<div class="allblurb_3">
			<img
				src="${pageContext.request.contextPath}/img/mancloth6.jpg" />
		</div>
	</div>
	<!--
        	作者：1120551142@qq.com
