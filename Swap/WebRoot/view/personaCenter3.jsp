...
<body style="background-color:#eee;">
    <%
        //设置当前地址
        session.setAttribute("adress","personaCenter3");
     %>
    <!--
            作者：756048962@qq.com
            时间：2015-12-20
    ...
    <div class="container" style="width: 1245px;">
        <div class="personCenter_left">
            <div class="personCenter_left_top">
                ...
                <div style="margin-top: 0;margin-bottom: 10px;">
                    <a href="#"
                        style="margin-left: 10px;margin-right: 40px;">信誉:<b
                        id="js-user-credit">${shopsCustom.reputationvalue }</b></a>
                    <a
                        href="${pageContext.request.contextPath}/goods/goodsCollectionSelect.do"
                        title="宝贝收藏"><span class="icon-heart icon-large"></span></a>
                    <a
                        href="${pageContext.request.contextPath}/shopsMessage/selectshopsMessage.do"
                        title="我的消息"><span
                        class="icon-envelope-alt icon-large"></span></a> <a
                        href="${pageContext.request.contextPath}/users/userAndShopQuery.do"
            ...
            <div class="personCenter_left_bottom">
                ...
                <div class="bottom_div"
                    style="background-color: #F58400;">
                    <p style="color: white;">
                        <a
                            href="${pageContext.request.contextPath}/shops/shopsCollectionSelect.do"
                            style="color: white;"><span class="icon-tags">&nbsp;店铺收藏</span></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
        ...
        <div class="personCenter_right02">
            <ul id="mytab" class="nav nav-tabs">
                <li class="active"><a href='#shop1'
                    data-toggle='tab'>店铺收藏</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane wow fadeIn in active" id="shop1">
                    <c:if test="${shopsCollection!=null}">
                        <c:forEach items="${shopsCollection}"
                            var="shopCollection">
                            <div class="shop_info_div0"
                                id="shoop_info_${shopCollection.id }">
                                <div class="shop_info_div1">
                                    <div class="shop_info_head">${shopCollection.shopsCustom.shopname }</div>
                                    <div class="shop_info_div2">
                                        <img
                                            src="/path/${shopCollection.shopsCustom.headimg }" />
                                    </div>
                                    <div class="shop_info_div3">
                                        <p>
                                            <a
                                                href="${pageContext.request.contextPath}/sellerCenter/sellerCenterSelect.action?shopId=${shopCollection.shopsCustom.id }">
                                                <span class="icon-user">&nbsp;${shopCollection.shopsCustom.username }</span>
                                            </a>
                                        </p>
                                        <p>
                                            <span>信誉:</span> <span style="color: #F58400;">${shopCollection.shopsCustom.reputationvalue }</span>
                                        </p>
                                        <p>
                                            <span> <a
                                                href="${pageContext.request.contextPath}/shopsCollection/shopsCollectionDelete.do?id=${shopCollection.id }"
                                                id="${shopCollection.id }"></a> <i title="收藏"
                                                class="icon-star icon-large shopman_click shopman_span3"></i>
                                            </span>
                                        </p>
                                    </div>
                                    <div class="shop_info_div4">
                                        <p>
                                            <span>入店时间:</span> <span><fmt:formatDate
                                                    value="${shopCollection.shopsCustom.createdate }"
                                                    pattern="yyyy-MM-dd" /></span>
                                        </p>
                                        <a href="#" data-toggle="modal" data-target="#respone-modal" id="${shopCollection.shopsCustom.userId }"
                                            class="button button-primary button-rounded button-tiny respone_a">留言</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <a href="${pageContext.request.contextPath}/sellerCenter/sellerCenterSelect.action?shopId=${shopCollection.shopsCustom.id }"
                                            class="button button-primary button-rounded button-tiny">进店</a>
                                    </div>
                                </div>
                                <c:if
                                    test="${shopCollection.shopsCustom.goods!=null}">
                                    <c:forEach
                                        items="${shopCollection.shopsCustom.goods}"
                                        var="goodsCollection" begin="0" end="2">
                                        <div class="shop_info_div5">
                                            <a
                                                href="${pageContext.request.contextPath}/blurb/blurbQuery.action?goods_id=${goodsCollection.id}">
                                                <p class="goods_info_imgs" style="">
                                                    <img src="/path/${goodsCollection.goodsimg1}" />
                                                </p>
                                                <p>
                                                    <span>${goodsCollection.goodsname}</span>
                                                </p>
                                            </a>
                                        </div>
                                    </c:forEach>
