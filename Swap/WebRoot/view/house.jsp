...
<html>
    ...
    <body>
            <%
            //设置当前地址
        session.setAttribute("adress","house");
        session.setAttribute("bigclassify","家居");
            /* 获取cookie */
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="house"  type="hidden"/>
                        ...
                        <div class="tab-pane fade" id="xw2">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    3<input name="adress" value="house"  type="hidden"/>
                                    <div class="form-group">
                                        <div class="has-feedback form-group-lg" style="width:300px;">
    ...
    <div class="container" style="margin-top: 60px;width: 1245px;">
        ...
        <div class="container allblurb">
            ...
            <div class="allblurb_1 wow fadeIn allblurb_query">
                        ...
                        <span><a href="#">厨具</a></span>
                        <span><a href="#">家具</a></span>
                        <span><a href="#">家装软饰</a></span>
                        <span><a href="#">清洁用品</a></span>
            ...
            <div class="allblurb_2">
                <ul class="allblurb_21">
                    <li>
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/home1.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/home2.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/home3.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/home4.jpg" alt="商品图片" />
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="javascript:">
                            <img src="${pageContext.request.contextPath}/img/home5.jpg" alt="商品图片" />
                        </a>
                    </li>
                </ul>
            ...
            <div class="allblurb_3">
                <img src="${pageContext.request.contextPath}/img/home6.jpg"/>
            </div>
        </div>
        <!--
            作者：1120551142@qq.com
