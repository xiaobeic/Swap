...
<html>
    ...
    <body>
            ...
            <%
        //设置当前地址
        session.setAttribute("adress","register");
        session.setAttribute("bigclassify","其他");
            /* 获取cookie */
    ...
    <div class="modal  fade" id="login-modal">
        <div class="modal-dialog" style="width:330px;">
            <div class="modal-content">
                        ...
                        <div class="tab-pane fade" id="xw1">
                            ...
                            <div class="container">
                                <form class="form-horizontal"
                                    ...
                                    method="post">
                                    <input name="adress" value="rest"  type="hidden"/>
                ...
                <input type="checkbox" />                            <input type="password" name="password" class="form-control" value="<%=password %>"
                                                placeholder="密码" />
                                        </div>
                                    </div>
            <input type="checkbox" name="isUseCookie" checked="checked"/>                         <div class="form-group">
