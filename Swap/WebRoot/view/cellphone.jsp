...
<html>
  <head>
	...
	<body>
			...
			<%
			//设置当前地址
			session.setAttribute("adress","cellphone");
			session.setAttribute("bigclassify","手机");
			/* 获取cookie */
						...
						<div class="tab-pane fade" id="xw1">
							...
							<div class="container">
								<form class="form-horizontal"
									...
									method="post">
									<input name="adress" value="cellphone"  type="hidden"/>
	...
	<div class="container" style="margin-top: 60px;width: 1245px;">
		...
		<div class="container allblurb">
			...
			<div class="allblurb_1 wow fadeIn allblurb_query">
				...
				<span><a href="#">华为</a></span>
				<span><a href="#">VIVO</a></span>
				<span><a href="#">乐视</a></span>
				<span><a href="#">OPPO</a></span>
				<span><a href="#">魅族</a></span>
				<span><a href="#">大神</a></span>
				<span><a href="#">神舟</a></span>
				<span><a href="#">小牛</a></span>
				<span><a href="#">诺基亚</a></span>
				<span><a href="#">金立</a></span>
				<span><a href="#">黑莓</a></span>
				<span><a href="#">三星</a></span>
				<span><a href="#">苹果</a></span>
				<span><a href="#">老人机</a></span>
			...
			<div class="allblurb_2">
				<ul class="allblurb_21">
					<li>
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/tele1.png" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/tele2.png" alt="商品图片" />
						</a>
					</li>
					<li style="none">
						<a href="javascript:">
							<img src="${pageContext.request.contextPath}/img/tele3.png" alt="商品图片" />
						</a>
					</li>
					<li style="display: none">
						<a href="javascript:">
			...
			<div class="allblurb_3">
				<img src="${pageContext.request.contextPath}/img/tele3.png"/>
			</div>
		</div>
		<!--
        	作者：1120551142@qq.com
